        ...
        <div className="flex flex-wrap justify-center gap-2 mb-12">
          ...
          {!showAll && allTags.length > 10 && (
            <button
              ...
              className="px-3 py-1.5 rounded-md text-xs font-mono border border-dashed border-[#2a2a2a] text-[#57534e] hover:border-amber-500/40 hover:text-amber-400 transition"
            >
